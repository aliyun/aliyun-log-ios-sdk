...
//
    ...
    _client = [[LOGClient alloc] initWithEndPoint:ENDPOINT accessKeyID:STS_AK accessKeySecret:STS_SK projectName:PROJECTNAME token:nil];
    
    
    
    //  log调试开关
    _client.mIsLogEnable = false;
}
