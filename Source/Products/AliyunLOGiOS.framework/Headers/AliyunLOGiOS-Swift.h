...
SWIFT_MODULE_NAMESPACE_PUSH("AliyunLOGiOS")
@class LogGroup;
@class NSURLResponse;
@class NSError;
...
- (nonnull instancetype)initWithEndPoint:(NSString * _Nonnull)endPoint accessKeyID:(NSString * _Nonnull)accessKeyID accessKeySecret:(NSString * _Nonnull)accessKeySecret projectName:(NSString * _Nonnull)projectName OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithEndPoint:(NSString * _Nonnull)endPoint accessKeyID:(NSString * _Nonnull)accessKeyID accessKeySecret:(NSString * _Nonnull)accessKeySecret token:(NSString * _Nonnull)token projectName:(NSString * _Nonnull)projectName;
