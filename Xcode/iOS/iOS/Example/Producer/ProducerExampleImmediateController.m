...
@interface ProducerExampleImmediateController ()
...
@implementation ProducerExampleImmediateController

static ProducerExampleImmediateController *selfClzz;
...
- (void) send {
    // 不建议使用
    // 不会聚合多条日志，会启动多个发送线程进行
    LogProducerResult result = [_client AddLog:[self oneLog] flush:1];
